...
class AlignedDatasetForSeg(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        A = AB.crop((0, 0, w1_3, h)).resize((self.opt.loadSize, self.opt.loadSize), Image.BICUBIC)

        seg = AB.crop((w1_3, 0, w2_3, h)).resize((self.opt.loadSize, self.opt.loadSize), Image.BICUBIC)

        B = AB.crop((w2_3, 0, w, h)).resize((self.opt.loadSize, self.opt.loadSize), Image.BICUBIC)
